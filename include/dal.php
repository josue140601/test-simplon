...
class tDAL
{
	var $tbltest_at_localhost__test_e;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "test-e", "varname" => "test_at_localhost__test_e", "altvarname" => "test_e", "connId" => "test_at_localhost", "schema" => "", "connName" => "test at localhost");
	}
