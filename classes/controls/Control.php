...
class EditControl
{
	...
	function __construct($field, $pageObject, $id, $connection)
	{
		...
		$this->searchOptions[CONTAINS] = "Contient";
		$this->searchOptions[EQUALS] = "Égal à";
		$this->searchOptions[STARTS_WITH] = "Commence avec";
		$this->searchOptions[MORE_THAN] = "Supérieure à";
		$this->searchOptions[LESS_THAN] = "Inférieur à";
		$this->searchOptions[BETWEEN] = "Entre";
		$this->searchOptions[EMPTY_SEARCH] = "Vide";
		$this->searchOptions[NOT_CONTAINS] = "Ne contient pas";
		$this->searchOptions[NOT_EQUALS] = "N'est pas égale à";
		$this->searchOptions[NOT_STARTS_WITH] = "Ne commence pas avec";
		$this->searchOptions[NOT_MORE_THAN] = "N'est pas supérieur à";
		$this->searchOptions[NOT_LESS_THAN] = "N'est pas inférieur à";
		$this->searchOptions[NOT_BETWEEN] = "N'est pas entre";
		$this->searchOptions[NOT_EMPTY] = "N'est pas vide";
...
*/		
	...
	public function getSearchCondition( $searchFor, $strSearchOption, $searchFor2 = "", $not = false )
	{
		if( substr( $strSearchOption, 0, 4) == "NOT " ) {
			$strSearchOption = substr( $strSearchOption, 4 );
			$not = true;
		}
		$cond = $this->getBasicFieldCondition( $searchFor, $strSearchOption, $searchFor2 );
