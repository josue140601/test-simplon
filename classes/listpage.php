...
class ListPage extends RunnerPage
{
	...
	function addCommonHtml()
	{
		...
		if($this->is508) {
			...
			$this->body["begin"].= "<a href=\"#skipmenu\" title=\""."Vers le menu"."\" class=\"".$this->makeClassName("s508")."\">"."Vers le menu"."</a>";
			$this->body["begin"].= "<a href=\"#skipsearch\" title=\""."Vers rechercher"."\" class=\"".$this->makeClassName("s508")."\">"."Vers rechercher"."</a>";
			$this->body["begin"].= "<a href=\"templates/helpshortcut.htm\" title=\""."Raccourci"."\" class=\"".$this->makeClassName("s508")."\">"."Raccourci"."</a>";
		}
...
//	normal mode row count
	...
	protected function orderFieldLabelString( $fName, $desc, $showLabelOnly )
	{
		...
		return $fName." ". ($desc ? "Haut en bas" : "De bas en haut");
	}
