...
//		SortForCrosstable($sort_y);
	...
	public function getPrintCrossHeader()
	{
		...
		return "<div>"."Groupe X"
			.":<b>".$this->fieldsTotalsData[ $this->xFName ]["label"]."</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"."Groupe Y"
			.":<b>".$this->fieldsTotalsData[ $this->yFName ]["label"]."</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"."Champ"
			.":<b>".$this->fieldsTotalsData[ $this->dataField ]["label"]."</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"."Fonction de regroupement"
	...
	protected function getPdfCrossHeader()
	{
		...
		$parts[] = "{ text: '"."Fonction de regroupement".":'}";
