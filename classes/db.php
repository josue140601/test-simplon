...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "test_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "test-e", "varname" => "test_at_localhost__test_e", "altvarname" => "test_e", "connId" => "test_at_localhost", "schema" => "", "connName" => "test at localhost");
		}
	}
