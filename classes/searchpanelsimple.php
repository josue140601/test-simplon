...
class SearchPanelSimple extends SearchPanel {
	...
	{	
		...
		$searchOpt_mess = ($searchPanelAttrs['srchOptShowStatus'] ? "Cacher les options de recherche" : "Montrer les options de recherche");
		...
		$searchforAttrs.= ' placeholder="'."recherche".'"';
	...
	function DisplaySearchPanel()
	{
		...
		$showHideOpt_mess = $this->srchPanelAttrs['ctrlTypeComboStatus'] ? "Cacher options" : "Montrer options";		
