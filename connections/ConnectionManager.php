...
class ConnectionManager
{
	...
	{
		return $this->byId( "test_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "test_at_localhost";
		$data["connName"] = "test at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;test;;1"; //currently unused

		$this->_connectionsIdByName["test at localhost"] = "test_at_localhost";
		...
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=test;OPTION=3";
		// encription set
		...
		$connectionsData["test_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["test-e"] = "test_at_localhost";
